...
package net.news.inrss.activity;
...
import net.news.inrss.adapter.DrawerAdapter;
import net.news.inrss.fragment.EntriesListFragment;
import net.news.inrss.parser.OPML;
...
import net.news.inrss.service.FetcherService;
import net.news.inrss.service.RefreshService;
import net.news.inrss.utils.PrefUtils;
import net.news.inrss.utils.UiUtils;
...
public class HomeActivity extends BaseActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void selectDrawerItem(int position) {
        ...
        if (PrefUtils.getBoolean(PrefUtils.FIRST_OPEN, true)) {
            ...
            builder.setTitle(Html.fromHtml("<font color='#FF7F27'>Welcome to inRSS. Would you like to add one feed?</font>"))
