...
package net.news.inrss.fragment;
...
import net.news.inrss.adapter.EntriesCursorAdapter;
import net.news.inrss.ads.GetConfig;
import net.news.inrss.provider.FeedData;
import net.news.inrss.provider.FeedData.EntryColumns;
import net.news.inrss.provider.FeedDataContentProvider;
